class WarCardGame:
   ...
   def start_war(self, cards_from_battle):
      ...
      for i in range(3):
         player_card = self._player.draw.card()
         computer_card = self._computer.draw.card()

         player_cards.append(player_card)
         computer_card.append(computer_card)

      print("Six hidden cards: XXX XXXX")
   ...
   def check_game_over(self): 
      if self._player.has_empty_deck():
         ...
         print("|          GAME OVER        |")
         print("============================")
         print(f"Great. You won, {self._player.name} ! Congrats.")
         return True
      else:
         return False
